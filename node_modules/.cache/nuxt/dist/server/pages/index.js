...
"use strict";
/* harmony import */ var _src_components_VSkeletonLoader_VSkeletonLoader_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(129);
...
/* harmony import */ var _mixins_elevatable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
...
/* harmony default export */ __webpack_exports__["a"] = (Object(_util_mixins__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(_mixins_elevatable__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], _mixins_measurable__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], _mixins_themeable__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"]).extend({
  ...
  methods: {
    ...
    genSkeleton() {
      const children = [];
      if (!this.isLoading) children.push(Object(_util_helpers__WEBPACK_IMPORTED_MODULE_5__[/* getSlot */ "j"])(this));else children.push(this.genStructure());
      /* istanbul ignore else */
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=4f1b99ce&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('back-to-top'),_vm._v(" "),_c('v-row',{attrs:{"justify":"space-between"}},[_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[(_vm.isFetching === true)?_c('v-sheet',{staticClass:"pa-3 mb-4"},_vm._l((5),function(i){return _c('v-skeleton-loader',{key:i,staticClass:"mx-auto mb-5",attrs:{"type":"card"}})}),1):_c('news-article',{attrs:{"article":_vm.newsArticlesFromUs}},[_c('h1',[_vm._v("Top Headlines")])])],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[(_vm.isFetching === true)?_c('v-sheet',{staticClass:"pa-3 mb-4"},_vm._l((5),function(i){return _c('v-skeleton-loader',{key:i,staticClass:"mx-auto mb-5",attrs:{"type":"card"}})}),1):_c('news-article',{attrs:{"article":_vm.newsArticlesFromUk}},[_c('h1',[_vm._v("Headlines From UK")])])],1)],1),_vm._v(" "),_c('v-row',{attrs:{"justify":"space-between my-2"}},[_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[(_vm.isFetching === true)?_c('v-sheet',{staticClass:"pa-3 mb-4"},_vm._l((5),function(i){return _c('v-skeleton-loader',{key:i,staticClass:"mx-auto mb-5",attrs:{"type":"card"}})}),1):_c('news-article',{attrs:{"article":_vm.newsArticleFromTec}},[_c('h1',[_vm._v("Top headlines from TechCrunch right now")])])],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[(_vm.isFetching === true)?_c('v-sheet',{staticClass:"pa-3 mb-4"},_vm._l((5),function(i){return _c('v-skeleton-loader',{key:i,staticClass:"mx-auto mb-5",attrs:{"type":"card"}})}),1):_c('news-article',{attrs:{"article":_vm.nigerianNews}},[_c('h1',[_vm._v("Headlines From Nigeria")])])],1)],1),_vm._v(" "),_c('v-row',{staticClass:"space-between my-2"},[_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[(_vm.isFetching === true)?_c('v-sheet',{staticClass:"pa-3 mb-4"},_vm._l((5),function(i){return _c('v-skeleton-loader',{key:i,staticClass:"mx-auto mb-5",attrs:{"type":"card"}})}),1):_c('news-article',{attrs:{"article":_vm.southAfrica}},[_c('h1',[_vm._v("Top headlines from South Africa")])])],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=4f1b99ce&scoped=true&

// EXTERNAL MODULE: ./components/news-article.vue + 19 modules
var news_article = __webpack_require__(128);

// EXTERNAL MODULE: ./components/back-to-top.vue + 2 modules
var back_to_top = __webpack_require__(108);

// EXTERNAL MODULE: external "@nuxtjs/axios"
var axios_ = __webpack_require__(97);
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  components: {
    newsArticle: news_article["default"],
    backToTop: back_to_top["default"]
  },
  name: "IndexPage",
  ...
  methods: {
    async getHeadlinesFromUs() {
      ...
      try {
        ...
        const req = await this.$axios.$get(`https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=${this.apiKey.US}`);
    ...
    async getHeadlinesFromUk() {
      try {
        ...
        const req = await this.$axios.$get(`https://newsapi.org/v2/top-headlines?country=gb&apiKey=${this.apiKey.nigeria}`);
        const data = await req;
        this.isFetching = false;
    ...
    async getTechcrunchNews() {
      try {
        this.isSearching = true;
        const req = await this.$axios.$get(`https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=${this.apiKey.nigeria}`);
        const data = await req;
        this.isFetching = false;
    ...
    async getNigeriaNews() {
      try {
        this.isSearching = true;
        const req = await this.$axios.$get(`https://newsapi.org/v2/top-headlines?country=ng&apiKey=${this.apiKey.nigeria}`);
        const data = await req;
        this.isFetching = false;
    ...
    async getSouthAfricaNews() {
      try {
        this.isSearching = true;
        const req = await this.$axios.$get(`https://newsapi.org/v2/top-headlines?country=za&category=entertainment&apiKey=${this.apiKey.nigeria}`);
        const data = await req;
        this.isFetching = false;
...
var VCol = __webpack_require__(136);
...
var VSkeletonLoader = __webpack_require__(137);
...
installComponents_default()(component, {BackToTop: __webpack_require__(108).default,NewsArticle: __webpack_require__(128).default})
...
installComponents_default()(component, {VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VRow: VRow["a" /* default */],VSheet: VSheet["a" /* default */],VSkeletonLoader: VSkeletonLoader["a" /* default */]})
