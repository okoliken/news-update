exports.ids = [7,1,2];
exports.modules = Array(81).concat([
/* 81 */
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/search-for-news.vue?vue&type=template&id=e462ace8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('v-btn',{attrs:{"nuxt":"","to":"/","color":"primary pb-1"}},[_vm._v(" go back ")]),_vm._v(" "),_c('h1',[_vm._v("Search for specific content")]),_vm._v(" "),_c('v-flex',{staticClass:"d-flex justify-center py-5"},[_c('v-text-field',{attrs:{"label":"Outlined","placeholder":"Placeholder","outlined":"","dense":""},model:{value:(_vm.query),callback:function ($$v) {_vm.query=$$v},expression:"query"}}),_vm._v(" "),_c('v-btn',{attrs:{"loading":_vm.isFetching,"color":"primary"},on:{"click":function($event){return _vm.getNewsBySearch()}}},[_c('v-icon',{attrs:{"size":"30"}},[_vm._v("mdi-magnify")])],1)],1),_vm._v(" "),_c('v-main',[(_vm.searchResponse.length > 0)?_c('v-btn',{attrs:{"loading":_vm.isFetching,"color":"primary"},on:{"click":function($event){return _vm.clearSearch()}}},[_vm._v("\n      clear search\n    ")]):_vm._e(),_vm._v(" "),_c('p',[_vm._v("Searched News would appear here")]),_vm._v(" "),(_vm.searchResponse.length > 0)?_c('back-to-top'):_vm._e(),_vm._v(" "),_c('v-container',[_c('h1',[_vm._v(_vm._s(_vm.query))]),_vm._v(" "),_c('v-row',{staticClass:"space-between my-2"},[_c('v-col',{attrs:{"cols":"12","sm":"6","md":"6"}},[(_vm.isFetching === true)?_c('v-sheet',{staticClass:"pa-3 mb-4"},_vm._l((5),function(i){return _c('v-skeleton-loader',{key:i,staticClass:"mx-auto mb-5",attrs:{"type":"card"}})}),1):_c('news-article',{attrs:{"article":_vm.searchResponse}},[_c('h1')])],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/search-for-news.vue?vue&type=template&id=e462ace8&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/search-for-news.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var search_for_newsvue_type_script_lang_js_ = ({
  data() {
    return {
      isFetching: false,
      query: "",
  ...
  methods: {
    async getNewsBySearch() {
      ...
      const req = await this.$axios.$get(`https://newsapi.org/v2/everything?q=${this.query}&from=${fullDate}&sortBy=popularity&apiKey=${this.US}`);
...
// CONCATENATED MODULE: ./pages/search-for-news.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_search_for_newsvue_type_script_lang_js_ = (search_for_newsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(10);
...
var VMessages = __webpack_require__(144);
...
var VCounter = __webpack_require__(146);
...
// CONCATENATED MODULE: ./pages/search-for-news.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_search_for_newsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var search_for_news = __webpack_exports__["default"] = (component.exports);
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VFlex: VFlex,VIcon: VIcon["a" /* default */],VMain: VMain["a" /* default */],VRow: VRow["a" /* default */],VSheet: VSheet["a" /* default */],VSkeletonLoader: VSkeletonLoader["a" /* default */],VTextField: VTextField_VTextField})


/***/ })
]);;
//# sourceMappingURL=search-for-news.js.map